...
def main_trading():
    ...
    if len(stocks_to_invest.keys()) == 0:
        return
    investment_list = []
...
async def background_task():
    ...
    j:schedule.Job = schedule.every(5).seconds
